...
public class Bed : MonoBehaviour, IInteractable
{
    ...
    [Tooltip("If false, the player will be able to interact with this bed without needing to complete the linked objective, and the Linked Objective will be ignored. If true, the player must complete the linked objective before they can interact with this bed, and the Linked Objective will need to be assigned.")]
    public bool needsObjective = true;

    [Tooltip("If true, interacting with the bed will add progress to the linked objective. If false, interacting with the bed will not add progress to the linked objective, but will still be locked based on the needs objective toggle.")]
    ...
    private IEnumerator WaitToLoadScene()
    {
        ...
        {
            Debug.LogError("Scene to load is not set on the bed.");
            yield break;
        }
