...
public class Reggie : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!animator)
        {
            Debug.LogError($"{this.name} has no animator assigned to the Reggie script");
        }
    }
    ...
    public void StartTravel()
    {
        ...
        Debug.Log("Reggie is now traveling to his destination");
    }
    ...
    public void TravelToTarget()
    {
        if (targetSpot == null)
        {
            Debug.Log("There is no target for Reggie to go to");
            return;
        }
        ...
        */
        ...
        if (!agent.pathPending && agent.remainingDistance <= stopDistance)
        {
            isTraveling = false;
            arrived = true;
            Debug.Log("Reggie reached the destination.");
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("door"))
        {
            ...
            Debug.Log("Reggie has reached the door.");
        }
    }
