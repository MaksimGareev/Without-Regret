...
public class HoodedGuy : MonoBehaviour
{
    ...
    public string npcName = "HoodedGuy";
    ...
    void Start()
    {
        ...
        if (!animator)
        {
            Debug.LogError($"{this.name} has no animator assigned to the Hooded Guy script");
        }
    }
    ...
    public void StartTravel()
    {
        ...
        Debug.Log("Hooded Guy is now traveling to his destination");
    }
    ...
    public void TravelToTarget()
    {
        if (targetSpot == null)
        {
            Debug.Log("There is no target for Hooded Guy to go to");
            return;
        }
        ...
        */
        ...
        if (!agent.pathPending && agent.remainingDistance <= stopDistance)
        {
            isTraveling = false;
            arrived = true;
            Debug.Log("Hooded Guy reached the destination.");
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("door"))
        {
            ...
            Debug.Log("Hooded Guy has reached the door.");
        }
    }
